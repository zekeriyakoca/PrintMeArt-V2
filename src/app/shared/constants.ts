...
export const RolledUpDefaultThumbnailUrl = 'https://ecombone.blob.core.windows.net/ecomm-processed-images/victorious-rock-0d8f88603.2.azurestaticapps.net/12/12-small.jpeg';

export const HahnemühleLogoUrl = 'https://genstorageaccount3116.blob.core.windows.net/printme-images/hahnemuehle.jpg';
...
export const FrameOptions: DesignFrame[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://www.ikea.com/nl/en/images/products/lomviken-frame-black__0386296_pe558681_s5.jpg?f=xxs',
...
export const FrameOptionsByValue: Record<string, DesignFrame> = FrameOptions.reduce(
  (acc, frame) => {
...
export const MuseumPapers: Paper[] = [
  {
    ...
    lookFeel: ['Natural colors', 'Balanced contrast', 'No glare', 'Premium cotton feel'],
    bestFor: ['Paintings / art reproductions', 'Illustrations', 'Soft tones, gallery style'],
    ...
    thumbnail: 'https://genstorageaccount3116.blob.core.windows.net/printme-images/paper-art-2.webp',
    grade: 'Museum',
    priceTier: '$$$',
  },
  {
    ...
    bestFor: ['Oil/acrylic style paintings', 'Artworks where texture adds value'],
    ...
    thumbnail: 'https://genstorageaccount3116.blob.core.windows.net/printme-images/paper-art-1.webp',
    grade: 'Museum',
    priceTier: '$$$',
  },
];
...
export const GalleryPapers: Paper[] = [
  {
    ...
    surface: 'Smooth, Matte',
    printType: 'Fine art pigment (giclée class)',
    lookFeel: ['Clean, neutral matte finish', 'High detail with a soft fine-art feel', 'No glare', 'Premium rag paper feel'],
    bestFor: ['Art reproductions and paintings', 'Photography that should look "fine art" (not glossy)', 'Neutral, color-accurate prints'],
    notIdealFor: ['Glossy or ultra-punchy photo look'],
    uxLabels: ['Gallery grade', 'Mat', 'Smooth', 'Color-accurate'],
    badgeTitle: 'Gallery Smooth',
    thumbnail: 'https://genstorageaccount3116.blob.core.windows.net/printme-images/paper-photo-1.webp',
    grade: 'Gallery',
    priceTier: '$$',
  },
];
...
const HomePapers: Paper[] = [
  {
    ...
    lookFeel: ['Vivid, accurate colors', 'Stunning depth', 'Smooth matte finish', 'Glare-free display'],
    bestFor: ['Best value art prints', 'Designers', 'Everyday art display', 'Budget-conscious buyers'],
    notIdealFor: ['Archival/museum-grade requirements'],
    uxLabels: ['Home grade', 'FSC-certified', 'Mat & Smooth'],
    badgeTitle: 'Home',
    thumbnail: 'https://genstorageaccount3116.blob.core.windows.net/printme-images/paper-fine-art-1.webp',
    grade: 'Home',
    priceTier: '$',
  },
];
...
export const AllPapers: Paper[] = [...HomePapers, ...StudioPapers, ...MuseumPapers, ...GalleryPapers];

// Grade badge colors
export const GradeBadgeColors: Record<PaperGrade, { bg: string; text: string }> = {
  Museum: { bg: 'bg-[#384f8c]/10', text: 'text-[#db2877]' },
  Gallery: { bg: 'bg-[#384f8c]/10', text: 'text-[#384f8c]' },
