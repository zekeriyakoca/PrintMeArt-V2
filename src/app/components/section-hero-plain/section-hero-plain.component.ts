...
export class SectionHeroPlainComponent {
  ...
  subHeading = input<string>('Shop Stunning Prints & Frames for Your Home Decor.');
  ...
  categories = input<CategoryCard[]>([
    {
      ...
      image: 'https://genstorageaccount3116.blob.core.windows.net/printme-processed-images/bc6ca6b1-d98a-421a-8627-4d7c4296e04a/bc6ca6b1-d98a-421a-8627-4d7c4296e04a-mockup1.jpeg',
